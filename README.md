...
display), promotions engine at checkout, staff scheduling, purchase-order
receiving flow, demand forecasting, and the **offline-sync layer** (the topic the
original design explored in depth). The schema already includes the tables these
need.
